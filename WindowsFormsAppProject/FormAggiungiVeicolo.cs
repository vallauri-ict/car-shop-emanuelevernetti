...
{
    public partial class FormAggiungiVeicolo : Form
    {
        ...
        public FormAggiungiVeicolo(BindingList<Veicolo> list, FormMain f)
        {
            InitializeComponent();
            bindingListVeicoli = list;
            this.formMain = f;
            DBPath = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\Utilities\\Veicoli.accdb";
        ...
        private void btnAggiungi_Click(object sender, EventArgs e)
        {
            ...
            if (rdbImgNo.Checked)
            {
                path = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\Utilities\\img/NoImage.jpg";
                filePicked = true;
            }
            if (filePicked)
            {
                ...
                else if (cmbTipoVeicolo.SelectedIndex == 0) //AUTO
                {
                    ...
                    if (rdbImgSì.Checked)
                    {
                        path = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\Utilities\\img/" + j + ".jpg";
                        File.Copy(f, Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\Utilities\\img/" + j + ".jpg");
                    }
